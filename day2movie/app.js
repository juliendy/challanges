// helpful docs : https://developers.themoviedb.org/3/getting-started/append-to-response
const API_URL =
...
// fetching relevant DOM elements to JS
...
function showMovies(movies) {
    ...
    movies.forEach((movie) => {
        ...
        // adding data to the above div with class 'movie'
        ...
        `;
        // appending it so that it gets reflected on the frontpage
