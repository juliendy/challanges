...
// adding an event listener to track the copy of the password to the clipboard
...
// adding an event listener to the generate button for generating a random string
